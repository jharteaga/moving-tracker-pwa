...
loginBtn.addEventListener('click', () => {
    ...
    if(userEmailInput !== "" && pwInput !== "" ){
        ...
        function errorCheck() {
            ...
            } else if (userToLogin.userError == "There is no user record corresponding to this identifier. The user may have been deleted.") {
                userEmailErrorMsg.innerHTML =
            ...
            //PW
            if (userToLogin.userError == "The password is invalid or the user does not have a password.") {
                pwErrorMsg.innerHTML = "Password is invalid";
                //Added for accent color - Meg Jul 10
                signInPwField.classList.add("error");
            } else if (userToLogin.userError == "Access to this account has been temporarily disabled due to many failed login attempts. You can immediately restore it by resetting your password or you can try again later.") {
