...
signUpBtn.addEventListener('click', () => {
  ...
  const termsAndConditionsInput = document.getElementById(
  ...
  const termsAndConditionsErrorMsg = document.getElementById(
    'termsAndConditionsErrorMsg'
  );
  ...
  const termsAndConditionsField = document.getElementById(
  ...
  if (
    ...
    pwInput !== '' &&
    confirmPwInput !== '' &&
    termsAndConditionsInput.checked
  ) {
    userToPush
      .userSignUp(userEmailInput, userNameInput, pwInput, confirmPwInput)
      .then(errorCheck);
...
const pwConfHidden = document.querySelector(
  '.sign-up-confirm-pw .fa-eye-slash'
);
